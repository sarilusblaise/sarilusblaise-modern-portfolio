...
export default function ToggleMenu() {
  ...
  return (
					...
					<button className='relative flex flex-col gap-[3px] justify-center items-center sm:hidden bg-gray-700 w-8 h-8 rounded-[50%] p-1'>
					<div className='w-[80%] absolute  bg-slate-300 h-[1.5px] rotate-45'></div>
					<div className='w-[80%] absolute  bg-slate-300 h-[1.5px] -rotate-45'></div>
				    </button>
