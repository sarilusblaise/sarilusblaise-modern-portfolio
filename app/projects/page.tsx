    ...
    <section className=" flex flex-col items-center   gap-16 p-4 sm:p-8 md:p-16 mt-32">
      <div>
        ...
        <p className="text-l md:w-4/6 lg:w-3/6">
          ...
          solve real-world problems. Each project listed here represents a
          unique challenge that I was able to tackle with my skills and
          expertise using a various of technologies.
        </p>
      </div>
